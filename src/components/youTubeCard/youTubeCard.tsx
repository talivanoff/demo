...
const YouTubeCard = () => {
    ...
    return (
        <div className={clsx(styles.card, isVisBut && styles.cardHover)}  onMouseLeave={handleMouseLeave}>
            ...
            {isVisBut && <div className={styles.buttons}>
            ...
            {isVisList && <div className={clsx(styles.list, isVisBut && styles.listHover)}> 
